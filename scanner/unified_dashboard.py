...
.grid4,.type-tabs{grid-template-columns:repeat(6,1fr)}@media(max-width:900px){.grid4,.type-tabs{grid-template-columns:1fr 1fr}}@media(max-width:600px){.grid4,.type-tabs{grid-template-columns:1fr}}
...
.f-exchanges{display:grid;grid-template-columns:1fr 1fr;gap:14px}.f-chart{padding:13px;border:1px solid #294438;border-radius:14px;background:#07100c}.f-chart svg{display:block;width:100%;height:auto}.f-timeframes,.f-stages,.f-plan,.f-scenarios,.f-zone-thirds{display:grid;gap:10px}.f-timeframes{grid-template-columns:repeat(4,1fr)}.f-stages,.f-plan,.f-scenarios,.f-zone-thirds{grid-template-columns:repeat(3,1fr)}.f-timeframes div,.f-stage,.f-plan div,.f-scenario,.f-zone-third{padding:13px;border:1px solid #294438;border-radius:12px;background:#07100c}.f-timeframes b,.f-stage strong,.f-zone-third b{display:block;color:#56d6ff}.f-stage strong{font-size:17px}.f-stage>span,.f-plan span,.f-scenario p,.f-zone-third span{color:var(--sub)}.f-zone-thirds{margin-top:10px}.f-zone-third.current{border-color:#56d6ff;background:#0a1c24}.f-zone-third b{margin-bottom:4px}.f-scenario.success{border-color:#00e783}.f-scenario.warning{border-color:#ffd166}.f-scenario.failure{border-color:#ff667e}@media(max-width:900px){.f-exchanges,.f-timeframes,.f-stages,.f-plan,.f-scenarios,.f-zone-thirds{grid-template-columns:1fr}}
...
.btc-correction{border-color:#ff8297;background:linear-gradient(145deg,#13090c,#09110d)}.btc-correction-head{display:flex;justify-content:space-between;gap:20px;align-items:start}.btc-correction-head h2{margin:0 0 4px;color:#ff9bac}.correction-alert{padding:5px 10px;border:1px solid #ff8297;border-radius:999px;color:#ffb4c1;font-size:12px;white-space:nowrap}.correction-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:9px;margin-top:15px}.correction-step{padding:13px;border:1px solid #493039;border-radius:13px;background:#090d0b}.correction-step strong{display:block;margin-bottom:5px;color:#ffb4c1}.correction-step b{display:block;margin-bottom:5px;font-size:16px}.correction-step span{color:var(--sub)}.correction-rule{margin-top:12px;padding:11px 13px;border-left:2px solid #ff8297;background:#140b0e;color:#e9d8dd}@media(max-width:900px){.correction-grid{grid-template-columns:1fr 1fr}}@media(max-width:600px){.btc-correction-head{flex-direction:column}.correction-grid{grid-template-columns:1fr}}
.dashboard-cockpit{display:grid;grid-template-columns:260px minmax(520px,1fr) 280px;gap:12px;align-items:stretch}.cockpit-card{margin:0;padding:16px;border:1px solid #243d4b;border-radius:15px;background:#04090d;overflow:hidden}.stage-focus{position:relative;display:flex;flex-direction:column;justify-content:flex-end;min-height:570px;border-color:var(--market-color);background:radial-gradient(circle at 50% 18%,color-mix(in srgb,var(--market-color) 18%,transparent),transparent 42%),#04090d}.stage-focus .cat-main{width:100%;height:280px}.stage-focus-label{font-size:13px;color:var(--sub)}.stage-focus-value{font-size:70px;line-height:1;font-weight:950;color:var(--market-color)}.stage-focus-name{font-size:25px;font-weight:900;color:var(--market-color)}.stage-focus ul{margin:12px 0 0;padding-left:18px;color:#c8d8d0}.btc-focus{display:flex;flex-direction:column;min-height:570px}.btc-focus .btc-tv-wrap{flex:1;height:auto;min-height:420px}.btc-focus-head{display:flex;justify-content:space-between;gap:14px;align-items:start;margin-bottom:10px}.btc-focus-head h2{margin:0;color:#f4fff8}.box-legend{display:flex;gap:13px;flex-wrap:wrap;margin:7px 0;color:#9fb1a7;font-size:11px}.box-legend span:before{content:"";display:inline-block;width:18px;height:2px;margin:0 5px 3px 0;background:var(--box-color)}.box-guide{margin-top:7px;color:#748b80;font-size:10px}.stage-side{min-height:570px;border-color:#33434d}.stage-side h2{font-size:18px}.stage-side .market-stage-grid{grid-template-columns:1fr;gap:7px}.stage-side .market-stage-card{padding:9px 11px}.stage-side .market-stage-card strong{font-size:14px}.stage-side .market-stage-card span{font-size:11px}.dashboard-flow{margin:12px 0}.dashboard-flow .market-chart-grid{grid-template-columns:repeat(3,1fr)}.dashboard-flow .tv-card{min-height:390px}.dashboard-flow .tradingview-widget-container{height:315px}.dashboard-bottom{display:grid;grid-template-columns:minmax(260px,.65fr) minmax(600px,1.35fr);gap:12px;margin-top:12px}.dashboard-bottom .btc-correction{margin:0}.market-summary-card{margin:0;border-color:var(--market-color)}.market-summary-card h2{color:var(--market-color)}.market-summary-list{margin:12px 0;padding-left:18px}.market-summary-action{display:flex;gap:14px;align-items:center;margin-top:14px;padding:11px;border:1px solid var(--market-color);border-radius:12px}.market-summary-action img{width:76px;height:90px;object-fit:contain}.market-summary-action b{display:block;color:var(--market-color)}@media(max-width:1100px){.dashboard-cockpit{grid-template-columns:220px 1fr}.stage-side{grid-column:1/-1;min-height:auto}.stage-side .market-stage-grid{grid-template-columns:repeat(3,1fr)}.dashboard-bottom{grid-template-columns:1fr}}@media(max-width:800px){.dashboard-cockpit{grid-template-columns:1fr}.stage-focus{min-height:auto}.stage-focus .cat-main{height:210px}.dashboard-flow .market-chart-grid,.stage-side .market-stage-grid{grid-template-columns:1fr}.dashboard-flow .tradingview-widget-container{height:360px}}
"""
...
def tradingview_widget(symbol, title, note):
    config = json.dumps({
        ...
        "hide_top_toolbar": False, "withdateranges": True, "calendar": False,
        "studies": ["STD;Donchian%1Channels"],
        "studies_overrides": {
            "donchian channels.length": 20,
            "donchian channels.upper.color": "#ff4d67",
            "donchian channels.basis.color": "#f0a500",
            "donchian channels.lower.color": "#2f8cff",
        },
        "support_host": "https://www.tradingview.com",
    }, ensure_ascii=False).replace("</", "<\\/")
    legend='<div class="box-legend"><span style="--box-color:#ff4d67">박스 상단</span><span style="--box-color:#f0a500">중심선</span><span style="--box-color:#2f8cff">박스 하단</span></div>'
    return f'''<div class="tv-card"><h3>{title}</h3><div class="sub">{note}</div>{legend}<div class="tradingview-widget-container"><div class="tradingview-widget-container__widget"></div><script type="text/javascript" src="https://s3.tradingview.com/external-embedding/embed-widget-advanced-chart.js" async>{config}</script></div><div class="box-guide">시간봉을 바꾸면 선택 시간봉의 최근 20개 봉 기준 박스선도 함께 다시 계산돼.</div></div>'''
...
def btc_correction_panel(box):
    """현재 30일 구조를 기준으로 BTC 조정 시작부터 훼손까지 대응 순서를 보여준다."""
    high=box.get("high");center=box.get("center")
    sell=box.get("sell_zone") or []
    buy=box.get("buy_zone") or []
...
def main_page(snapshot, btc):
    ...
    for i,r in enumerate(rows):
        ...
        trs.append(f'<tr class="row-click" data-type="{r.get("type")}" data-market="{fmt(r.get("market"))}" data-action="{fmt(r.get("action"))}" onclick="toggleScanRow({i})"><td><button class="star" data-market="{fmt(r.get("market"))}" onclick="event.stopPropagation();togglePin(\'{fmt(r.get("market"))}\',this)">☆</button></td><td><b>{fmt(r.get("market"))}</b><br><small class="sub">눌러서 차트 보기</small></td><td>{fmt(r.get("type"))}형</td><td>{action_cell(r)}</td><td>{fmt(r.get("score"))}</td><td>{fmt(r.get("price"))}<br><small class="sub">{dist_text(r)}</small></td><td>{fmt(r.get("entry"))}<br><small class="sub">평균 {fmt(plan.get("average_entry"))}</small></td><td>{fmt(r.get("stop"))}</td><td>{fmt(targets[0] if targets else None)}<br><small class="sub">{target_more}</small></td><td>{fmt(r.get("rr"))}R</td></tr><tr id="scanDetail{i}" class="expand scan-detail"><td colspan="10">{detail}</td></tr>')
...
def dashboard_page(snapshot, watch, btc, market_data, regime):
    ...
    btc_location=box_location_text(binance_box)
    box_legend='<div class="box-legend"><span style="--box-color:#ff4d67">박스 상단</span><span style="--box-color:#f0a500">중심선</span><span style="--box-color:#2f8cff">박스 하단</span></div>'
    body=intro+f'''<section class="dashboard-cockpit" style="--market-color:{market_color}">
<div class="cockpit-card stage-focus"><div class="stage-focus-label">현재 시장 단계</div><div class="stage-focus-value">{stage}</div><div class="stage-focus-name">{name}</div><img class="cat-main" src="{cat}" alt="시장 {stage} 숙도지"><div class="market-reason-title">왜 {stage}인가?</div><ul>{reasons}</ul><div class="proxy-note">신뢰도 {fmt(regime.get("confidence"))}% · 알트 진입한도 {size}%</div></div>
<div class="cockpit-card btc-focus"><div class="btc-focus-head"><div><h2>BTCUSDT · BINANCE</h2><div class="sub">상단 시간봉 메뉴에서 분·시간·일·주봉을 직접 선택해.</div></div><div><b>{usdt(binance.get("price"))}</b><div class="sub">{str((binance.get('basis') or {}).get('four_hour_end','-')).replace('T',' ')} 완성봉</div></div></div>{box_legend}{bitcoin_tradingview_widget()}<div class="box-guide">돈치안 박스 · 선택한 시간봉의 최근 20개 봉 기준으로 상단·중심·하단이 자동 변경돼.</div><div class="btc-summary-grid"><div class="btc-summary-item"><span>일봉 해석</span><b>{fmt(btc.get("daily_state"))}</b></div><div class="btc-summary-item"><span>4시간봉 해석</span><b>{fmt(btc.get("four_hour_state"))}</b></div><div class="btc-summary-item"><span>현재 가격 위치</span><b>{fmt(btc_location)}</b></div><div class="btc-summary-item"><span>고정 조정 기준</span><b>바이낸스 30일 완성봉 박스</b></div></div></div>
<aside class="cockpit-card stage-side"><h2>M단계 설명</h2><div class="sub"><b>M은 Market(시장)의 약자</b>야. M5는 무조건 좋은 단계가 아니라 과열·수익보호 구간이야.</div><div class="market-stage-grid">{stage_cards}</div></aside>
</section>
{market_gate_panel(regime)}
<section class="panel dashboard-flow"><div class="btc-live-head"><div><h2>알트 자금 흐름 핵심 차트</h2><div class="sub">모든 차트에서 시간봉 선택 가능 · 선택 시간봉에 맞춰 박스 상단·중심·하단 자동 변경</div></div><div class="sub">BTC.D ↓ + TOTAL2 ↑ + OTHERS ↑ 동시 확인</div></div><div class="market-flow-strip"><div class="market-flow-stat"><span>BTC.D · {btcd_period}</span><b>{btcd_value}</b></div><div class="market-flow-stat"><span>TOTAL2 · {total2_period}</span><b>{total2_value}</b></div><div class="market-flow-stat"><span>OTHERS · {others_period}</span><b>{others_value}</b></div><div class="market-flow-stat"><span>알트 상승 종목 · 24H</span><b>{breadth_value}</b></div></div><div class="market-chart-grid">{tradingview_widget("CRYPTOCAP:BTC.D","BTC.D","비트코인 도미넌스")}{tradingview_widget("CRYPTOCAP:TOTAL2","TOTAL2","BTC 제외 전체 알트 시총")}{tradingview_widget("CRYPTOCAP:OTHERS","OTHERS","상위 10개 제외 중소형 시총")}</div><div class="proxy-note">차트는 TradingView 원본 지수, 자동판정값은 CoinGecko 상위 125개 프록시를 사용해.</div></section>
<section class="dashboard-bottom" style="--market-color:{market_color}"><div class="panel market-summary-card"><h2>시장 요약</h2><ul class="market-summary-list"><li>{stage} · {name}</li><li>{fmt(regime.get("plain"))}</li><li>BTC 위치 · {fmt(btc_location)}</li><li>알트 신규진입 한도 · {size}%</li></ul><div class="market-summary-action"><img src="{cat}" alt="시장 행동 숙도지"><div><b>{stage} · 오늘의 행동</b><span>{fmt(mascot_advice)}</span><div class="sub">시장 단계가 바뀌면 숙도지의 표정과 행동 안내도 함께 바뀌어.</div></div></div></div>{btc_correction_panel(binance_box)}</section>'''
...
def training_page(key, basis):
    color = INFO[key][1]
    if key == "F":
        upbit_svg='''<svg viewBox="0 0 520 220" role="img" aria-label="업비트 PROM 신고가 상승 예시"><rect width="520" height="220" fill="#050a07"/><path fill="none" stroke="#56d6ff" stroke-width="4" d="M15 192 L70 188 L120 182 L170 168 L220 145 L270 117 L320 78 L365 39 L405 64 L450 46 L505 57"/><circle cx="365" cy="39" r="6" fill="#56d6ff"/><text x="375" y="31" fill="#f5fff8" font-size="12">업비트 신고가</text></svg>'''
        binance_svg='''<svg viewBox="0 0 520 220" role="img" aria-label="바이낸스 PROM 과거 횡보 매물대 예시"><rect width="520" height="220" fill="#050a07"/><rect x="35" y="54" width="450" height="54" fill="#56d6ff" opacity=".14"/><path fill="none" stroke="#8aa0b4" stroke-width="3" d="M15 92 L55 68 L90 96 L130 65 L170 88 L210 62 L250 91 L290 70 L330 101 L370 73 L410 95 L450 66 L505 85"/><path fill="none" stroke="#56d6ff" stroke-width="4" d="M15 194 L90 190 L160 180 L230 161 L300 137 L360 108 L410 74 L455 89 L505 82"/><text x="45" y="47" fill="#56d6ff" font-size="12">과거 횡보 매물대 5.83~6.66 USDT</text></svg>'''
        intro=page_intro("훈련소 · F형","업비트의 짧은 신고가 차트와 글로벌 거래소의 긴 과거 차트를 함께 읽는 교과서","업비트 신고가 확인 → 글로벌 매물대 확인 → F1·F2·F3 대응")
        body=intro+f'''
<section class="panel" style="--accent:{color}"><h2>1. 왜 글로벌 차트를 같이 봐야 하나</h2><div class="f-exchanges"><article class="f-chart"><h3>UPBIT · PROM/KRW</h3><div class="sub">상장 이력이 짧아 계속 신고가처럼 보임</div>{upbit_svg}</article><article class="f-chart"><h3>BINANCE · PROM/USDT</h3><div class="sub">2025년 장기 횡보 매물대가 현재 가격에 존재</div>{binance_svg}</article></div><p class="help-note">PROM은 업비트에서는 신고가 상승처럼 보이지만, 바이낸스에서는 과거 매물대 안에 들어온 F2 상태다.</p></section>
<section class="panel" style="--accent:{color}"><h2>2. 시간봉은 역할만 간단히 구분</h2><div class="f-timeframes"><div><b>글로벌 일봉</b>과거 매물대 위치</div><div><b>업비트 일봉</b>신고가 추세 유지</div><div><b>4시간봉</b>하단 지지·상단 돌파</div><div><b>5분봉</b>실제 재지지 타점</div></div></section>
<section class="panel" style="--accent:{color}"><h2>3. F형은 세 단계만 기억</h2><div class="f-stages"><article class="f-stage"><strong>F1 · 신고가 상승</strong><span>업비트 신고가 추세가 이어지고 글로벌 매물대에 접근 중.</span><b>판단 · 진입가 대기</b></article><article class="f-stage"><strong>F2 · 매물대 도착</strong><span>글로벌 과거 횡보 범위 안에 들어와 상승이 멈추거나 흔들림.</span><b>판단 · 확인 대기</b></article><article class="f-stage"><strong>F3 · 매물대 돌파</strong><span>상단을 완성봉으로 돌파하고 첫 눌림에서 상단을 다시 지지.</span><b>판단 · 진입 검토</b></article></div><h3 style="margin-top:16px">F2 안에서는 현재 위치만 세 칸으로 본다</h3><div class="f-zone-thirds"><div class="f-zone-third"><b>하단 · 0~33%</b><span>하단 지지 여부 확인. 손익비가 가장 유리한 구간.</span></div><div class="f-zone-third"><b>중앙 · 33~67%</b><span>매물 소화 중. 방향이 정해질 때까지 확인.</span></div><div class="f-zone-third"><b>상단 · 67~100%</b><span>돌파와 윗꼬리 저항이 갈리는 구간. F3 전환 확인.</span></div></div></section>
<section class="panel" style="--accent:{color}"><h2>4. 진입 · 손절 · 청산</h2><div class="f-plan"><div><b>진입</b><span>F2 하단 지지 또는 F3 상단 돌파·재지지</span></div><div><b>손절</b><span>확인한 하단·돌파선 종가 이탈</span></div><div><b>청산</b><span>매물대 내부 분할, 돌파 시 잔량 추세 추종</span></div></div></section>
<section class="panel" style="--accent:{color}"><h2>5. 성공 · 경고 · 실패 복기</h2><div class="f-scenarios"><article class="f-scenario success"><h3>성공</h3><p>F2에서 매물을 소화한 뒤 F3 돌파·재지지. 상승 추세 연장.</p></article><article class="f-scenario warning"><h3>경고</h3><p>매물대 안에서 윗꼬리와 거래량 급증 반복. 하단 재시험 가능.</p></article><article class="f-scenario failure"><h3>실패</h3><p>매물대 하단 또는 F3 돌파선을 종가로 이탈. F형 가설 종료.</p></article></div><div class="training-close" style="grid-template-columns:repeat(3,1fr)"><div><b>먼저 볼 것</b><span>글로벌 과거 이력</span></div><div><b>현재 단계</b><span>F1·F2·F3 중 하나</span></div><div><b>실행 기준</b><span>지지·돌파 완성봉</span></div></div></section>'''
        return shell("훈련소 F형",body,basis,"training_f")
    if key == "E":
        intro = page_intro(
            "훈련소 · E형",
