...
HISTORY = {
    "oco": {
        ...
        "entries": [
            ...
            ("2026-09-07", "R9", "저유동성 종목 제외 기준 및 스캔 재시도 안정화"),
            ("2026-09-02", "R8", "모바일 최근 업데이트 시각·검색 접근성 보강"),
            ("2026-08-31", "R7", "BTC 과거 횡보 구조 기준 박스 재산정 및 차트 연동"),
            ("2026-08-31", "R6", "모바일 보조차트 이동·팬·가독성 개선"),
            ("2026-08-24", "R5", "확정 PC·모바일 메인 대시보드 UI 및 숙돌이 자산 반영"),
            ("2026-08-24", "R4", "통합 시장 대시보드·시장 단계/후보 압축 구조 적용"),
